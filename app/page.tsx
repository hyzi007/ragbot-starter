...
const customPrompts = [
  "Jak nastavit chatbota?",
  "Jaké jsou nejčastější problémy s chatboty?",
  "Best practices pro konverzační AI",
  "Jak integrovat chatbota do webové stránky?"
];
        ...
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>Knowledge Base Assistant</h1>
            </div>
          ...
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">
            Jsem váš asistent pro znalostní databázi. Ptejte se mě na cokoliv ohledně chatbotů, jejich nastavení, řešení problémů nebo best practices. Odpovědi čerpám z naší databáze znalostí.
          </p>
        </div>
